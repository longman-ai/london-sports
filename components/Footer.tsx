      ...
      <div className="w-full max-w-6xl px-5 sm:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div className="md:col-span-4">
            ...
            {/* Newsletter — was permanently disabled ("coming soon"); now
                functional, storing subscribers in Postgres. Fixed 2026-07-27
                NovaList audit. */}
          ...
          <div className="md:col-span-2">
            <h3 className="text-xs font-semibold text-stone-300 uppercase tracking-wider mb-4">Company</h3>
            <ul className="space-y-2.5">
              <li><Link href="/about" className="text-stone-400 hover:text-white text-sm transition-colors">About</Link></li>
              <li><Link href="/contact" className="text-stone-400 hover:text-white text-sm transition-colors">Contact</Link></li>
              <li><Link href="/privacy" className="text-stone-400 hover:text-white text-sm transition-colors">Privacy Policy</Link></li>
            </ul>
          </div>
        </div>
